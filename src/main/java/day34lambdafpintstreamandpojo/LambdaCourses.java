...
public class LambdaCourses {
    public static void main(String[] args) {
        ...
        System.out.println(sortCourseWithAverageScoreInAscendingSkipThird(coursesList));
    }
    ...
    //5) Homework: Sort the list elements according to the average score in ascending order and print just 3rd one

    public static List<Courses> sortCourseWithAverageScoreInAscendingSkipThird(List<Courses> list) {
