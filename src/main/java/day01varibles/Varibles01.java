...
public class Varibles01 {
    ...
    public static void main(String[] args) {
       ...
       //Example 1: Create a varıable whose value is 1.99
        ...
        /*
            ...
            byte variable use 8 bits in memory
            ...
            long variable use 64 bits in memory
        ...
        //Note: Java accepts long values as integer as default. But if your value is greater than the maximum value of
        //      integers you will get error. To fix that error you have to put "L" or "l" to the end of the number.
        ...
        /*
          ...
          1)float: It is used for decimal values(like 12.99 , 5.23)
                 ...
                 When you create a "flaot" variable, you have to use "F" or "f" at the end of the value
          2)double: It is used for decimal value
