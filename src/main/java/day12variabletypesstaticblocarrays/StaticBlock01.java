package day12variabletypesstaticblocarrays;
  ...
  /*
     1) If you do not assign any value for "static" and "non-static" variables, Java assigns "default value" to
        them but Java does not assign default value for "local variables"
...
public class StaticBlock01 {
    ...
    /*
      ...
      6) "static block" is used to initialize (assigning first value) "static variable"

      Note: When we create a variables inside the main methods, we do not use "static" keyword, because
    ...
    static{
            System.out.println("This is main bloc 2");
    }
