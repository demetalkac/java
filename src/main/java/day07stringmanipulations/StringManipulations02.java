...
public class StringManipulations02 {
    public static void main(String[] args) {
        ...
        //Example 1: Change all digit  to "*" in the given String
       ...
       //Note: If your code does not work for all value, it is called "Hard Coding" and "Hard Coding" cannot be accepted
      ...
      */
       ...
       /*
        ...
        //Following can be used to remove space as well but it is difficult to notice space was removed,
        // because of that above is better to use
